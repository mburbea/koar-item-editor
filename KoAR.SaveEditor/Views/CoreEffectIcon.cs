...
namespace KoAR.SaveEditor.Views
{
    public sealed class CoreEffectIcon : Control
    {
        ...
        private static readonly DependencyPropertyKey _coreEffectPropertyKey = DependencyProperty.RegisterReadOnly(nameof(CoreEffectIcon.CoreEffect), typeof(object), typeof(CoreEffectIcon),
        ...
        public object? CoreEffect
        {
            get => (object?)this.GetValue(CoreEffectIcon.CoreEffectProperty);
