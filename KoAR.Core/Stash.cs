...
public sealed class Stash
{
    ...
    public StashItem AddItem(ItemDefinition type)
    {
        ...
        var header = new StashItemHeader(type, _gameSave.IsRemaster);
        ...
        Count++;
        Items.Add(CreateStashItem(_gameSave, offset, buffer.Length, []));
    ...
    public void DeleteItem(StashItem item)
    {
        ...
        Items.Remove(item);
        _gameSave.Body = MemoryUtilities.ReplaceBytes(_gameSave.Body, item.ItemOffset, itemLength, []);
        Count--;
    ...
    private readonly struct StashItemHeader(ItemDefinition type, bool isRemaster)
    {
        public readonly uint TypeId = type.TypeId;
        public readonly short VersionIndicator = (short)(isRemaster ? 0x04_0A : 0x03_0A);
        public readonly int Pocket = 0;
        public readonly float MaxDurability = isRemaster && type.Category.IsJewelry() ? 100f : type.MaxDurability;
        public readonly int Quantity = 1;
        public readonly int PlayerBuffsLength = type.PlayerBuffs.Length;
    }
}
